...
class PrecisionRecallFMeasureForDoc(BaseMetric, ClassNursery):
    def __init__(self, datasets_manager: DatasetsManager):
        ...
        """
        super(PrecisionRecallFMeasureForDoc, self).__init__(datasets_manager=datasets_manager)
    ...
    def calc_metric(
        self, lines: List[DocLines], labels: List[DocLabels], model_forward_dict: Dict[str, Any]
    ) -> None:
